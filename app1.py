...
Study_Hours=st.number_input("**Study  time(hrs)**",min_value=0.0,max_value=24.0,step=0.1,format="%.9f")
Sleep_Hours=st.number_input('**Sleep  time(hrs)**',min_value=0.0,max_value=24.0,step=0.1,format="%.9f")
# action button
